...
var f[I*I] integer;     #fecha en la que se jugo i vs j   #PORQUE?
#var a integer <= n - r ;
...
#subto r_t: forall <i, k> in {3..n}*K with k != 2*(n-1): (sum <j> in I_s: x[i, j, k] + x[j, i, k] + x[i, j, k+1] + x[j, i, k+1]) <= 1;
